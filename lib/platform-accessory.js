...
exports.LevelSensePlatformAccessory = void 0;
/**
 * Platform Accessory
 ...
 */
// @ts-ignore
class LevelSensePlatformAccessory {
    ...
    async pushReading(readings) {
        ...
        this.contactSensorOneService.updateCharacteristic(this.platform.Characteristic.ContactSensorState, this.toContactSensorCharacteristic(contactSensor1.currentValue));
        this.contactSensorTwoService.updateCharacteristic(this.platform.Characteristic.ContactSensorState, this.toContactSensorCharacteristic(contactSensor2.currentValue));
    }
    /**
    ...
    findTemp(readings) {
        return readings?.sensorLimit.find((limit) => limit.sensorSlug === 'tempc');
    }
    findHumidity(readings) {
        return readings?.sensorLimit.find((limit) => limit.sensorSlug === 'rh');
    }
    findInput1(readings) {
        return readings?.sensorLimit.find((limit) => limit.sensorSlug === 'input1');
    }
    findInput2(readings) {
        return readings?.sensorLimit.find((limit) => limit.sensorSlug === 'input2');
    }
    toContactSensorCharacteristic(currentValue) {
...
exports.LevelSensePlatformAccessory = LevelSensePlatformAccessory;
//# sourceMappingURL=platform-accessory.js.map